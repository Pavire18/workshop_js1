/*
        ...
        movilidad en Madrid, nos piden que todos tengan etiqueta de contaminación.4565HLM'
...
function filterCar(coches){
    coches.forEach(element => {
      element.etiqueta= element.modelo==='híbrido' ? 'ECO' : 'C';
    });
    return coches;
}

console.log(filterCar(datos));